      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form id="search_form" name="search_form" method="post" action="<?php echo base_url()."admin/manage_bulk_edit/search/"; ?>">
            ...
            <form method="post" action="<?php echo base_url(); ?>admin/manage_bulk_edit/create">
            <div class="box-body table-responsive no-padding">
                <div class="col-md-12">
                        <label style="float:left">
                                <button type="submit" class="btn btn-info">Bulk Update</button>
                        </label>
                    </div>
                <table class="table table-bordered table-hover">
                            ...
                            foreach($resultset->result() as $result_row)
                            {
                                ...
                                ?>
                                    <tr>
                                        <td><?php echo $i; ?><input type="hidden" id="txt_pr_id[]" name="txt_pr_id[]" value="<?php echo $result_row->product_id; ?>"></td>
                                        <td>
                                            <input type="text" id="txt_pr_name[]" name="txt_pr_name[]" value="<?php echo $result_row->product_name; ?>" style="width:300px">
                                        </td>
                                            ...
                                            <td>
                                                <input type="text" id="txt_pr_model_no[]" name="txt_pr_model_no[]" value="<?php echo $result_row->product_model_no; ?>" style="width:100px">
                                            </td>
                                            <td>
                                                <input type="text" id="txt_pr_sku[]" name="txt_pr_sku[]" value="<?php echo $result_row->product_sku; ?>" style="width:100px">
                                                </td>
                                            ...
                                            <td>
                                                <input type="text" id="txt_pr_mrp[]" name="txt_pr_mrp[]" value="<?php echo $result_row->product_mrp; ?>" style="width:60px">
                                            </td>
                                            <td>
                                                <input type="text" id="txt_pr_selling_price[]" name="txt_pr_selling_price[]" value="<?php echo $result_row->product_selling_price; ?>" style="width:60px">
                                            </td>
                                            <td>
                                                <input type="text" id="txt_pr_quantity[]" name="txt_pr_quantity[]" value="<?php echo $result_row->product_quantity; ?>" style="width:60px">
                                            </td>
