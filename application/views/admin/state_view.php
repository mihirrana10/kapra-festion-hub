                        ...
                        <div class="box box-primary">
                            <form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_state/create" enctype="multipart/form-data">
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                                    <label>Code</label>
                                                    <input class="form-control" id="txt_state_code" name="txt_state_code">
                                        </div>
                                        <div class="form-group">
                                                    <label>Country</label>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                  <!--<h3 class="box-title" style="font-size:25px">State List</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form id="search_form" name="search_form" method="post" action="<?php echo base_url()."admin/manage_state/search/"; ?>">
                ...
                <table class="table table-bordered table-hover">
                            ...
                            ?>
                                ...
                                <td><?php echo $i; ?></td>
                                    ...
                                    <td><?php echo $result_row->state_code; ?></td>
