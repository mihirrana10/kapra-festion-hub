                                ...
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="input-group my-colorpicker2">
                                                      <input type="text"  id="txt_product_color" name="txt_product_color" class="form-control">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <div class="input-group date">
                                                      ...
                                                      <input type="text" class="form-control pull-right" id="txt_product_date" name="txt_product_date" >
                                                    </div>
                                        </div>
                                        <div class="form-group">
                                                    <label>Image</label>
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" id="txt_product_desc" name="txt_product_desc" rows="3"></textarea>
                                        </div>
                                        <div class="form-group">
                                                    <label>Status</label>
                                                    <?php 
                ...
                <table class="table table-bordered table-hover">
                            ...
                            ?>
                                ...
                                <td><?php echo $i; ?></td>
                                    ...
                                    <td><?php echo $result_row->product_color; ?></td>
                                    <td><?php echo $result_row->product_date; ?></td>
                                    <td><img src="<?php echo base_url(); ?>files/admin/product/thumb/<?php echo $result_row->product_image; ?>" width="40px"></td>
                ...
                if (req.readyState == 4) {
                    ...
                    //alert(req.responseText);                      
                        document.getElementById("edit_div").innerHTML=req.responseText;
                            ...
                            $('#txt_product_date_2').datepicker({
                                format: 'yyyy-mm-dd',
                                autoclose: true
                            })
                            CKEDITOR.replace( "txt_product_desc2", {
                                fullPage: true,
                                allowedContent: true,
...
<script>
  $(function () {
                                            ...
                                            $('#txt_product_date').datepicker({
                                              format: 'yyyy-mm-dd',
                                              autoclose: true
                                            })
                                            CKEDITOR.replace( "txt_product_desc", {
                                                fullPage: true,
                                                allowedContent: true,
                                                extraPlugins: "wysiwygarea"
