                            ...
                            <form role="form" method="post" action="<?php echo base_url(); ?>admin/manage_sms_provider/create" enctype="multipart/form-data">
                                <div class="box-body">
                                        ...
                                        <div class="form-group">
                                                    ...
                                                    <input class="form-control" id="txt_sms_provider_username" name="txt_sms_provider_username">
                                        </div>
                                        <div class="form-group">
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                  <!--<h3 class="box-title" style="font-size:25px">SMS Provider List</h3>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <form id="search_form" name="search_form" method="post" action="<?php echo base_url()."admin/manage_sms_provider/search/"; ?>">
                                        <div class="form-group" style="float:right">
                                                <!--<label>Search: -->
                                                    <input class="form-control" type="text" id="txt_search" name="txt_search" placeholder="Search sms provider name"  onKeyDown="submit_form(event);"
