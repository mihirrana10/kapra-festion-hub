<aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php 
        $menu_res=$this->db->get("tbl_menu");
        foreach($menu_res->result() as $menu_row)
        {
          $submenu_res=$this->db->get_where('tbl_submenu',array('menu_id'=>$menu_row->menu_id));
          ?>
            ...
            <!--<li class="active">-->
            <li>
            <a href="<?php echo base_url().'admin/'.$menu_row->menu_url.''; ?>">
                <i class="fa <?php echo $menu_row->menu_fa_icon; ?>"></i> <span><?php echo $menu_row->menu_name; ?></span>
            </a>
            <?php 
            }
            else
            ...
            if($submenu_res->num_rows()>0)
            {
              ...
              <ul class="treeview-menu">
                ...
                {
                  ?>
                  <li><a href="<?php echo base_url().'admin/'.$submenu_row->submenu_url; ?>"><i class="fa fa-circle-o"></i> <?php echo $submenu_row->submenu_name; ?></a></li>
                  <?php
                }
                ?>
