...
<!-- Mirrored from portotheme.com/html/molla/contact.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 12 Jun 2020 07:37:42 GMT -->
<?php
...
<body>
    <div class="page-wrapper">
        ...
        <main class="main">
            ...
            <div class="container">
	        	<div class="page-header page-header-big text-center" style="background-image: url('<?php echo base_url(); ?>template/user/assets/images/contact-header-bg.jpg')">
	                				...
	                				<div class="row">
	                					<div class="col-sm-5 col-xl-6">
	                						<figure class="store-media mb-2 mb-lg-0">
	                							<img src="<?php echo base_url(); ?>template/user/assets/images/stores/img-1.jpg" alt="image">
	                		...
	                		<div class="col-lg-6">
	                			<div class="store">
	                				<div class="row">
	                					<div class="col-sm-5 col-xl-6">
	                						<figure class="store-media mb-2 mb-lg-0">
	                							<img src="<?php echo base_url(); ?>template/user/assets/images/stores/img-2.jpg" alt="image">
	                						</figure><!-- End .store-media -->
	                					</div><!-- End .col-xl-6 -->
...
<!-- Mirrored from portotheme.com/html/molla/contact.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 12 Jun 2020 07:37:45 GMT -->
</html>