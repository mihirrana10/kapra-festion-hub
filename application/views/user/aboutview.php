...
<!-- Mirrored from portotheme.com/html/molla/about.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 12 Jun 2020 07:37:17 GMT -->
<?php
...
<body>
    ...
    <!-- End .header -->
        ...
        <main class="main">
            ...
            <div class="container">
	        	<div class="page-header page-header-big text-center" style="background-image: url('<?php echo base_url(); ?>template/user/assets/images/about-header-bg.jpg')">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 offset-lg-1">
                                <div class="about-images">
                                    <img src="<?php echo base_url(); ?>template/user/assets/images/about/img-1.jpg" alt="" class="about-img-front">
                                    <img src="<?php echo base_url(); ?>template/user/assets/images/about/img-2.jpg" alt="" class="about-img-back">
                ...
                <div class="container">
                            ...
                            <div class="brands-display">
                                <div class="row justify-content-center">
                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/1.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/2.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/3.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/4.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/5.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/6.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/7.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/8.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->

                                    <div class="col-6 col-sm-4">
                                        <a href="#" class="brand">
                                            <img src="<?php echo base_url(); ?>template/user/assets/images/brands/9.png" alt="Brand Name">
                                        </a>
                                    </div><!-- End .col-sm-4 -->
                                </div><!-- End .row -->
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="<?php echo base_url(); ?>template/user/assets/images/team/member-1.jpg" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="<?php echo base_url(); ?>template/user/assets/images/team/member-2.jpg" alt="member photo">
                        ...
                        <div class="col-md-4">
                            <div class="member member-anim text-center">
                                <figure class="member-media">
                                    <img src="<?php echo base_url(); ?>template/user/assets/images/team/member-3.jpg" alt="member photo">
                    ...
                    <div class="container">
                        ...
                        <div class="owl-carousel owl-simple owl-testimonials-photo" data-toggle="owl" 
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="<?php echo base_url(); ?>template/user/assets/images/testimonials/user-1.jpg" alt="user">
                            ...
                            <blockquote class="testimonial text-center">
                                <img src="<?php echo base_url(); ?>template/user/assets/images/testimonials/user-2.jpg" alt="user">
...
<!-- Mirrored from portotheme.com/html/molla/about.html by HTTrack Website Copier/3.x [XR&CO'2013], Fri, 12 Jun 2020 07:37:27 GMT -->
</html>