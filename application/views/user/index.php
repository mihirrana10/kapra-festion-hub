        ...
        <?php 
            ...
            <div class="container">
                <ul class="nav nav-pills nav-border-anim nav-big justify-content-center mb-3" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="products-featured-link" data-toggle="tab" href="#products-featured-tab" role="tab" aria-controls="products-featured-tab" aria-selected="true">Categories</a>
                    </li>
                  
                </ul>
            </div>
            <div class="brands-border owl-carousel owl-simple col align-self-center" data-toggle="owl" 
                data-owl-options='{
                    "nav": false, 
                            "dots": false,
                            "margin": 0,
