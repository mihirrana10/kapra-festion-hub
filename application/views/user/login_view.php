							...
							<div class="tab-content">
                                ...
                                <form action="<?php echo base_url('login/login_check'); ?>" method="post">
							    		<div class="form-group">
							    			...
							    			<input type="text" class="form-control" id="singin-email-2" name="txt_user_email" required>
							    		</div><!-- End .form-group -->

							    		<div class="form-group">
							    			<label for="singin-password-2">Password *</label>
							    			<input type="password" class="form-control" id="singin-password-2" name="txt_user_password" required>
							    		</div><!-- End .form-group -->
                                ...
                                <form role="form" method="post" action="<?php echo base_url(); ?>user/manage_user/create" enctype="multipart/form-data">
							    		...
							    		<div class="form-group">
							    			...
							    			<input type="password" class="form-control" id="register-password-2" name="txt_user_password" required>
							    		</div><!-- End .form-group -->
